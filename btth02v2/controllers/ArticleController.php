 ...
 class ArticleController{
    ...
    include('views/article/list_article.php');
     ...
     public function update($id){
        $articleService = new ArticleService($id);
        $article = $articleService->getUpdateArticles($_POST['txtmatbviet'],$_POST['txttieude'],$_POST['txttenbaihat'],$_POST['txttloai'],$_POST['txttomtat'],$_POST['txtnoidung'],$_POST['txtnoidung'], $_POST['Y-m-d H:i:s'], $_POST['file-upload']);
        include('views/article/list_article.php');
     }
     public function add(){
          $articleService = new ArticleService();
